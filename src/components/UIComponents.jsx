...
export const baseInput = "border rounded-lg px-3 py-2 w-full text-sm focus:ring-2 focus:ring-sky-400 focus:outline-none transition-all";
const baseBtn = "px-4 py-2 rounded-lg text-sm font-medium focus:ring-2 focus:ring-offset-2 transition-colors flex items-center justify-center";

export const Input = ({ label, required, error, readOnly, className = "", ...props }) => {
  return (
...
export const Button = ({ variant = "sky", children, className = "", ...props }) => {
  const variants = {
    ...
    outline: `${baseBtn} border border-gray-300 text-gray-700 hover:bg-gray-100 focus:ring-gray-200`,
  };
