...
const OpdBillAnalysis = () => {
  ...
  data?.mergedData?.[0]?.tenant_id ??
  data?.data?.[0]?.tenant_id
);
...
const handleExport = () => {
  ...
  const scaledColumnWidths =
    baseColumnWidths.map(
      (width) =>
        width * widthScale
    );
...
...(showSpectacle
  ...
  return (
    <div className="p-0">
      <h1 className="text-2xl font-semibold text-gray-700 mb-6">Opd Analysis</h1>
      <CopyFilterBar
