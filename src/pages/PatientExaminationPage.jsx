...
import PatientExaminationDetails from "./PatientExaminationDetails";
import PatientExaminationList from "./PatientExaminationList";
...
const PatientExaminationPage = () => {
  ...
  return (
    <div className="max-w-[1400px] mx-auto mt-4">
      ...
      {activeTab === "form" ? <PatientExaminationDetails /> : <PatientExaminationList />}
