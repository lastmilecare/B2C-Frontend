  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        if (!payload) {
          healthAlerts.error(
            "Patient detail missing please verify before proceeding.",
            "Error",
          );
          return;
        }
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <Select
                      ...
                      error={
                        formik.touched.localAddressState &&
                        formik.errors.localAddressState
                      }
                    >
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <DiseaseSelect
                      ...
                      onChange={(selected) =>
                        formik.setFieldValue("diseases", selected)
                      }
                      required
                    />
...
export default PatientRegistrationOhc;
