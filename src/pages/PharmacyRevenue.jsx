...
const PharmacyRevenueForm = ({ editingId, editRow, onSuccess, onCancel }) => {
  const [activeStep, setActiveStep] = useState(1);

  const [createRevenue] = useCreatePharmacyRevenueMutation();
  const [updateRevenue] = useUpdatePharmacyRevenueMutation();
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold text-slate-800 flex items-center gap-2">
            ...
            {editingId ? "Update Pharmacy Revenue" : "Pharmacy Revenue Entry"}
          </h1>
...
export default PharmacyRevenueForm;
